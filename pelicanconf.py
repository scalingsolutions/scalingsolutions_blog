...
AUTHOR = u'ScalingSolutions'

SITENAME = u'Scaling Solutions'
SITESUBTITLE = u'Data Science, Physics, and Commentary'
...
MENUITEMS = [('Archives', '/archives.html'),
             ('Home Page', 'http://scalingsolutions.net')]
NEWEST_FIRST_ARCHIVES = False

#Github include settings
#GITHUB_USER = 'mcminis1'
#GITHUB_REPO_COUNT = 0
